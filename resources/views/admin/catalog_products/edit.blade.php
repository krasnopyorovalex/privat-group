                                            ...
                                            <div class="panel panel-flat border-blue border-xs" id="image__box">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="btn-group btn__actions">
                                                        ...
                                                        <button type="button" data-href="{{ route('admin.images.destroy', ['id' => $catalogProduct->image->id]) }}" class="btn delete__img btn-danger btn-labeled btn-labeled-right btn-xs">Удалить <b><i class="icon-trash"></i></b></button>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
