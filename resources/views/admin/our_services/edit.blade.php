                        ...
                        <div class="tab-pane active" id="main">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    @input(['name' => 'title', 'label' => 'Title', 'entity' => $ourService])
                                    @input(['name' => 'description', 'label' => 'Description', 'entity' => $ourService])
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-9">
                                    @input(['name' => 'alias', 'label' => 'Alias', 'entity' => $ourService])
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
