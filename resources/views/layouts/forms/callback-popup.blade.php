<div class="modal" tabindex="-1" role="dialog" id="callback-popup">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('send.callback-popup') }}" id="form__callback-popup" onsubmit="yaCounter54461437.reachGoal('ZAKAZ_ZVONKA'); return true">
                    @csrf
                    <div class="form-wrap">
