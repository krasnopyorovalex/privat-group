...
@section('content')
    <section class="breadcrumbs-custom">
        <div class="breadcrumbs-custom-body parallax-content context-dark bg-inside-pages">
            <div class="container">
                <h1 class="breadcrumbs-custom-title">{{ $product->name }}</h1>
            </div>
        </div>
            ...
            <div class="row row-30">
                <div class="col-lg-5">
                    ...
                    <div class="single-product-image">
                        <img src="{{ $product->image->path }}" alt="{{ $product->name }}" title="{{ $product->name }} от агентства недвижимости Private Estate">
                    </div>
                    @endif
                </div>
                <div class="col-lg-7">
